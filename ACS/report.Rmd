...
DT::datatable(parameters(),rownames = FALSE,
          ...
          caption = tags$caption(
            ...
            tags$em(tags$h5(strong("Table 1:"),"Parameters")))
          )
...
DT::datatable(cm_table,rownames = FALSE,container = sketch,
          ...
          caption = tags$caption(
            style = 'caption-side: top; text-align: center;',
            tags$em(tags$h5(strong("Table 2:"),"Confusion matrix")))
          )
```
...
DT::datatable(metrics_matrix,rownames = FALSE,
         ...
         caption = tags$caption(
           style = 'caption-side: top; text-align: center;',
           tags$em(tags$h5(strong("Table 3:"),"Metrics related to the classification performance of the model")))
)
```
...
```{r, echo=FALSE} 
  ...
  rules_table=arules::DATAFRAME(model()$rules)[,-5]
  ...
  DT::datatable(rules_table[,1:5],rownames = FALSE,
            ...
            caption = tags$caption(
              style = 'caption-side: top; text-align: center;',
              tags$em(tags$h5(strong("Table 4: "),"Association rules used by the classification algorithm")))
            )
